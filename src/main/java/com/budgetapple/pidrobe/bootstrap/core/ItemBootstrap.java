...
=======
        Item tshirt1 = new Item(-1, 10, imageBase64("green_shirt"), "#00ff00", Item.MAX_TEMP_INDEX, true, Gender.UNISEX);
        Item tshirt2 = new Item(-1, 10, imageBase64("red_shirt"), "#ff0000", Item.MAX_TEMP_INDEX, true, Gender.UNISEX);
        Item tshirt3 = new Item(-1, 10, imageBase64("blue_shirt"), "#0000ff", Item.MAX_TEMP_INDEX, true, Gender.UNISEX);
        Item tshirt4 = new Item(-1, 10, imageBase64("white_shirt"), "#ffffff", Item.MAX_TEMP_INDEX, true, Gender.UNISEX);
        Item tshirt5 = new Item(-1, 10, imageBase64("black_shirt"), "#000000", Item.MAX_TEMP_INDEX, true, Gender.UNISEX);

        Item jeans1 = new Item(-1, 9, imageBase64("jeans1"), "#1560BD", 3, true, Gender.UNISEX);
        Item jeans2 = new Item(-1, 9, imageBase64("jeans2"), "#696969", 3, true, Gender.MALE);
        Item jeans3 = new Item(-1, 9, imageBase64("jeans3"), "#000000", 3, true, Gender.MALE);
        Item shorts1 = new Item(-1, 5, imageBase64("shorts1"), "#1560BD", Item.MAX_TEMP_INDEX, true, Gender.MALE);
        Item shorts2 = new Item(-1, 5, imageBase64("shorts2"), "#000000", Item.MAX_TEMP_INDEX, true, Gender.MALE);

        Item shoes1 = new Item(-1, 4, imageBase64("shoes1"), "#000000", 2, true, Gender.MALE);
        Item shoes2 = new Item(-1, 4, imageBase64("shoes2"), "#000000", 2, true, Gender.UNISEX);
        Item shoes3 = new Item(-1, 4, imageBase64("shoes3"), "#111111", 2, true, Gender.MALE);
        Item flipflop1 = new Item(-1, 2, imageBase64("flipflop1"), "#000000", Item.MAX_TEMP_INDEX, true, Gender.UNISEX);
        Item flipflop2 = new Item(-1, 2, imageBase64("flipflop2"), "#00ff00", Item.MAX_TEMP_INDEX, true, Gender.UNISEX);

        Item boots1 = new Item(-1, 0, imageBase64("male_boots"), "#A0522D", 1, true, Gender.MALE);
        Item boots2 = new Item(-1, 0, imageBase64("female_boots"), "#654321", 1, true, Gender.FEMALE);

        Item coat1 = new Item(-1, 1, imageBase64("male_coat"), "#393c16", 1, true, Gender.MALE);
        Item coat2 = new Item(-1, 1, imageBase64("female_coat"), "#f5f5dc", 1, true, Gender.FEMALE);

        Item jacket1 = new Item(-1, 3, imageBase64("male_jacket"), "#A0522D", 2, true, Gender.MALE);
        Item jacket2 = new Item(-1, 3, imageBase64("female_jacket"), "#696969", 2, true, Gender.FEMALE);

        Item sleeves1 = new Item(-1, 6, imageBase64("male_shirts"), "#1560BD", 3, true, Gender.MALE);
        Item sleeves2 = new Item(-1, 6, imageBase64("female_shirts"), "#add8e6", 3, true, Gender.FEMALE);

        Item suit1 = new Item(-1, 7, imageBase64("male_suit"), "#000080", 2, true, Gender.MALE);
        Item suit2 = new Item(-1, 7, imageBase64("female_suit"), "#696969", 2, true, Gender.FEMALE);

        Item sweater1 = new Item(-1, 8, imageBase64("male_sweater"), "#696969", 1, true, Gender.MALE);
        Item sweater2 = new Item(-1, 8, imageBase64("female_sweater"), "#ffa500", 1, true, Gender.FEMALE);

        Item vest1 = new Item(-1, 11, imageBase64("male_vest"), "#696969", 2, true, Gender.MALE);
        Item vest2 = new Item(-1, 11, imageBase64("female_vest"), "#ffa500", 2, true, Gender.FEMALE);
>>>>>>> 74504506923bcaec5f7a24876fee437918ee9fb3
